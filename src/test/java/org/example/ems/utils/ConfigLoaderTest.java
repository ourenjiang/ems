...
public class ConfigLoaderTest {
    public static void main(String[] args) {
        // 获取整个配置
        Map<String, Object> fullConfig = ConfigLoader.getConfig("application.yml");
...
//        System.out.println("功能选项: " + options);
        ...
        Map<String, Object> database = ConfigLoader.getValue("database");
        for (Map.Entry<String, Object> item : database.entrySet()) {
